...
{   
    ...
    public class PedidoRepository : BaseRepositiry<Pedido>, IPedidoRepository
    {
        ...
        public PedidoRepository(ApplicationContext contexto, IHttpContextAccessor contextAcessor, IItemPedidoRepository itemPedidoRepository, ICadastroRepository cadastroRepository) : base(contexto)
        {
